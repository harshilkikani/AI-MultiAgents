...
def sample_leads():
    ...
    return [
        # --- Septic (4) ---
        {"label": "Septic — pumping emergency", "contact_name": "Darlene Hatcher", "contact_email": "darlene@hatcherseptic.com",
        ...
        {"label": "Septic — install quote", "contact_name": "Ray Kowalski", "contact_email": "ray@kowalskipumping.com",
        ...
        {"label": "Septic — shopping", "contact_name": "Tina Browne", "contact_email": "tina@brownesepticllc.com",
        ...
        {"label": "Septic — curious", "contact_name": "—", "contact_email": "office@mainestreet-septic.com",
         "message": "Saw this on a webinar. What exactly does it do?",
         "source": "newsletter", "urgency": "low"},

        # --- Roofing (4) ---
        {"label": "Roofing — storm surge", "contact_name": "Mike Calloway", "contact_email": "mike@calloway-roofing.com",
        ...
        {"label": "Roofing — commercial", "contact_name": "Jaylen Briggs", "contact_email": "jay@briggsroofingco.com",
        ...
        {"label": "Roofing — pricing curious", "contact_name": "Alyssa Chen", "contact_email": "alyssa@chenroofing.net",
        ...
        {"label": "Roofing — just browsing", "contact_name": "—", "contact_email": "curious@gmail.com",
         "message": "Just poking around. Cool concept.",
         "source": "google ad", "urgency": "low"},

        # --- HVAC (4) ---
        {"label": "HVAC — peak season", "contact_name": "Brian Holt", "contact_email": "brian@holtair.com",
        ...
        {"label": "HVAC — emergency repairs", "contact_name": "Priya Shah", "contact_email": "priya@shahhvac.com",
        ...
        {"label": "HVAC — shopping around", "contact_name": "Tom Delgado", "contact_email": "tom@delgadohvacpro.com",
        ...
        {"label": "HVAC — no budget", "contact_name": "—", "contact_email": "maybelater@gmail.com",
